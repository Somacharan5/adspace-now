...
import { ArrowRight, Shield, Mail, Lock, User as UserIcon } from "lucide-react";
  ...
  const handleEmailAuth = async () => {
    ...
    try {
      if (mode === "signup") {
        ...
        toast.success("Account created! Welcome to Xads.");
        navigate("/home");
      } else {
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {mode === "signup" ? "Start your first billboard campaign" : "Sign in to manage your campaigns"}
            </p>
          </div>
